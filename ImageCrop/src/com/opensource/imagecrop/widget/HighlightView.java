...
/**
 * <p/>This class is used by CropImageView to display a highlighted cropping rectangle<br/>
 * overlayed with the image. There are two coordinate spaces in use. One is<br/>
 * image, another is screen. computeLayout() uses mMatrix to map from image<br/>
 * space to screen space.<br/>
 *
...
public class HighlightView {
    ...
    public void setMatrixValue(Matrix src) {
        if(null == mMatrix) {
            return;
        }
        mMatrix.set(src);
    ...
    public boolean postTranslate(float deltaX, float deltaY) {
    ...
    /**
     * Handles motion (dx, dy) in screen space.<br/>
     * <br/><p/>The "edge" parameter specifies which edges the user is dragging.
     *
     * @param edge
     * @param dx
     * @param dy
    ...
    /**
     * Get the cropping rectangle in image space.
     * @return The cropping rectangle in image space.
     */
    ...
    /**
     * Get the drawing rectangle in image space.
     * @return The drawing rectangle in image space.
     */
    ...
    private void init() {
        ...
        mResizeDrawableWidth = resources.getDrawable(R.drawable.ic_crop_width);
        mResizeDrawableHeight = resources.getDrawable(R.drawable.ic_crop_height);
